...
module.exports = {  
    ...
    CLIENTS: [{     
        ...
        IPFILTER_FILE_PATH:              ENV.CLIENT_IPFILTER_FILE_PATH                    ? ENV.CLIENT_IPFILTER_FILE_PATH                                  : '/root/bittorrent/ipfilter.dat',
        BITTORRENT_SPEED_PORT_FILE_PATH: ENV.CLIENT_BITTORRENT_SPEED_PORT_FILE_PATH       ? ENV.CLIENT_BITTORRENT_SPEED_PORT_FILE_PATH                     : '/root/.wine/drive_c/users/root/Local Settings/Application Data/BitTorrentHelper/port',
    }],     
    ...
    AUTOREMOVE_SIZE_QUOTA_PER_DRIVE_GB:  ENV.AUTOREMOVE_SIZE_QUOTA_PER_DRIVE_GB           ? parseInt(ENV.AUTOREMOVE_SIZE_QUOTA_PER_DRIVE_GB)               : 64,
    ...
    AUTOCONFIG_SETTINGS: {     
        ...
        rand_port_on_start:              ENV.AUTOCONFIG_SETTINGS_RAND_PORT_ON_START       ? parseBoolean(ENV.AUTOCONFIG_SETTINGS_RAND_PORT_ON_START)       : false,
        upnp:                            ENV.AUTOCONFIG_SETTINGS_UPNP                     ? parseBoolean(ENV.AUTOCONFIG_SETTINGS_UPNP)                     : false,
